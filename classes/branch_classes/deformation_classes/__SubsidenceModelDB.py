...
from classes.branch_classes.deformation_classes.__SubsidanсeCellDB import __SubsidenceCellDB
...
class __SubsidenceModelDB(SegmentedModelABC):
    ...
    def __init__(self, reference_model: SegmentedModelABC,
        ...
        self.mse_data = None
        self.cell_type = __SubsidenceCellDB
