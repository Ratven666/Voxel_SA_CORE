...
from db_models.subsidence_models_table import create_subsidence_models_db_table
...
class TableInitializer(metaclass=SingletonMeta):
    ...
    def __init__(self, metadata):
        ...
        self.subsidence_models_db_table = create_subsidence_models_db_table(self.__db_metadata)
